...
For GUI use, please download this setup (SGWR_Model_WINDOWS_0.4_setup.exe) from the above and just follow the installation steps. You should be able to run the GUI in your local computer without using any programming. 
